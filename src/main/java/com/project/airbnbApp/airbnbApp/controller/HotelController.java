package com.project.airbnbApp.airbnbApp.controller;
...
import com.project.airbnbApp.airbnbApp.service.HotelService;
...
public class HotelController {
    ...
    @PutMapping("/{hotelId}")
    @Operation(summary = "Update a hotel by Id", tags = {"Admin Hotel"})
    ...
    @Operation(summary = "Delete a hotel by Id", tags = {"Admin Hotel"})
    ...
    @Operation(summary = "Activate a hotel by Id", tags = {"Admin Hotel"})
