...
import com.project.airbnbApp.airbnbApp.entity.*;
...
import com.project.airbnbApp.airbnbApp.repository.*;
import com.project.airbnbApp.airbnbApp.service.BookingService;
import com.project.airbnbApp.airbnbApp.service.CheckoutService;
import com.project.airbnbApp.airbnbApp.strategy.PricingService;
    ...
    public BookingDto initialiseBooking(BookingRequest bookingRequest) {
        ...
        if (!room.getHotel().getId().equals(bookingRequest.getHotelId())) {
            throw new IllegalArgumentException(
                    "Room " + bookingRequest.getRoomId() + " does not belong to hotel " + bookingRequest.getHotelId());
        }
