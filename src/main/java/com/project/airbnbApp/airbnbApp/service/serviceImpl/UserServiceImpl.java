...
import com.project.airbnbApp.airbnbApp.service.UserService;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public User getUserById(long id) {
        return userRepository.findById(id).orElseThrow(() -> new TypePool.Resolution.NoSuchTypeException("User not found with id: " + id));
    }
